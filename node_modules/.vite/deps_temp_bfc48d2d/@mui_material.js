...
var Tooltip = React81.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React81.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime97.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
...
var Tab = React99.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime121.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime121.jsxs)(React99.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime121.jsxs)(React99.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
